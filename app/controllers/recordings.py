...
from app.services import azure_speech_service, recording_session_service, transcribe_job_service
...
async def transcribe(
    ...
    background.add_task(
        ...
        audio.content_type or "application/octet-stream", language, mode == "conversation",
    )
    return _job_out(job)
